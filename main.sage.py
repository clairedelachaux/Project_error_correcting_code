...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_256 = Integer(256); _sage_const_255 = Integer(255); _sage_const_246 = Integer(246); _sage_const_0x03B1 = Integer(0x03B1); _sage_const_5 = Integer(5); _sage_const_0p001 = RealNumber('0.001')
def Van(x, k):
    n = len(x)
    M = matrix(F, k, n)
    for i in range(k):
...
# Perform simulations 
n_sim = _sage_const_5        # Number of simulation
n_fail = _sage_const_0        # Number of simulation where decoding failure occurs
t = (n - k)//_sage_const_2 


# Perform simulations with channel noise
bit_error_prob = _sage_const_0p001   # Bit error probability
...
for i in range(n_sim):
    ...
    # Simulate channel noise by flipping bits with a certain probability
    for j in range(len(r)):
        if random() < bit_error_prob:
            r[j] = F.random_element()  # Flip the bit
